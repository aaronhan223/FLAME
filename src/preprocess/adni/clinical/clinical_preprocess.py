...
# Required Files
clinical_1 = pd.read_csv('/export/io79/data/schaud35/datasets/adni/clinical/MEDHIST_09Apr2026.csv')
clinical_2 = pd.read_csv('/export/io79/data/schaud35/datasets/adni/clinical/NEUROEXM_09Apr2026.csv')
clinical_3 = pd.read_csv('/export/io79/data/schaud35/datasets/adni/clinical/PTDEMOG_09Apr2026.csv')
clinical_4 = pd.read_csv('/export/io79/data/schaud35/datasets/adni/clinical/RECCMEDS_09Apr2026.csv')
clinical_5 = pd.read_csv('/export/io79/data/schaud35/datasets/adni/clinical/VITALS_09Apr2026.csv')
...
final.to_csv('/export/io79/data/schaud35/datasets/adni_processed/clinical/clinical_merged.csv', index=True)
...
final_2.to_csv('/export/io79/data/schaud35/datasets/adni_processed/clinical/clinical_merged_mean.csv', index=True)
