...
if __name__ == "__main__":
    ...
    multitask_model = torch.load(f'/cis/home/schaud35/clinical-highmmt/src/checkpoints/{args.fusion_model}/{multitask}/{args.task}/mimic_iv_{args.task}_{task_mods_dict[args.task+"_mod"]}.pt')
    multitask_model_enc = torch.load(f'/cis/home/schaud35/clinical-highmmt/src/checkpoints/{args.fusion_model}/{multitask}/{args.task}/mimic_iv_{args.task}_{task_mods_dict[args.task+"_mod"]}_{args.task.upper().split("-")[0]}_encoder.pt')
