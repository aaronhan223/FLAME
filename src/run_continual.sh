...
SEEDS=(42)
CL_METHODS=('ewc' 'ours' 'lora')
FUSION_MODEL='fusemoe'
GATING='laplace'
MOD_DROP_RATE='0.0'
EXPERTS=5
# TASK_RAW='ihm-mortality-birads;pheno-readmission-density;los-diag-risk'
TASK_RAW='pheno-mortality;los-readmission-risk;ihm-birads-density' # 'pheno-birads;los-risk;ihm-density' # 'pheno-birads;los-mortality-risk;ihm-readmission-density'
...
ENCODER_FREEZE_MODE='all_trainable' #'first_appearance'
